    ...
    <div class="flex justify-between mx-auto w-full Site-Max-Width p-4 pt-2">
        ...
        <div class="w-full flex justify-center">
            <div class="w-full max-w-3xl px-4 lg:px-0">
                ...
                <form action="{{ route('allProperties') }}" method="GET" id="search-form">
                    ...
                    <div class="flex justify-center">
                        <div class="flex">
                            <button id="bhk_button" data-dropdown-toggle="bhk_dropdown"
                                ...
                                <svg aria-hidden="true" class="ml-1 md:mt-1 w-4 h-4" fill="currentColor"
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <select name="sort_by" id="sort_by"
                        class="text-darker-3 border-0 p-0 focus:ring-0 bg-gray-50 w-44" onchange="updateSortBy(this)">
