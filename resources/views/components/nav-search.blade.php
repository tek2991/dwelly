<div class="flex justify-between fixed w-full z-20 Gradient-Top-Banner pt-3">
    <div class="flex justify-between mx-auto w-full Site-Max-Width p-4 pt-2">
        ...
        <div class="w-full flex justify-center">
            <form action="#" method="get" class="w-full max-w-3xl px-4 lg:px-0">
                <script>
        ...
        <div class="items-center my-auto">
            <button type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation"
                ...
                class="inline-flex items-center justify-center p-2 mb-2 rounded-md text-darker-3 hover:text-piss-yellow transition duration-150 ease-in-out">
