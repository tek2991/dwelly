<div class="bg-white rounded-lg shadow dark:bg-gray-700">
    ...
    <div class="p-6">
        <h3 class="my-2 text-lg font-normal text-gray-500 dark:text-gray-400 text-center"> Confirm Onboarding Audit
        </h3>
        ...
        @else
            @if ($canStartAudit)
                <p class="py-3 font-semibold">
                    Once you start the audit, you will not be able to edit the property data. Are you sure you want to
                    start the audit?
                </p>
                <div class="pt-4 pb-2">
                    <button wire:click="startAudit"
